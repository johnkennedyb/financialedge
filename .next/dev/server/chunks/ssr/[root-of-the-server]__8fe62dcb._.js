...
async function getPostsByCategorySlug(categorySlug, limit = 12) {
...
async function getPostsByCategory(categorySlug, limit = 12) {
    if (!WP_API_URL) {
        throw new Error("WordPress API URL not configured");
    }
    try {
        // First get the category ID from the slug
        const categoryResponse = await fetch(`${WP_API_URL}/wp/v2/categories?slug=${categorySlug}`, {
            next: {
                revalidate: 3600
            },
            headers: {
        ...
        const postsResponse = await fetch(`${WP_API_URL}/wp/v2/posts?categories=${categoryId}&per_page=${limit}&_embed`, {
            next: {
                revalidate: 300
            },
            headers: {
...
async function HomePage() {
    let wpPosts = [];
    try {
        wpPosts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$wp$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getLatestPosts"])(12);
    } catch  {
        wpPosts = [];
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8fe62dcb._.js.map