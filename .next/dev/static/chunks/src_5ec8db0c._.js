...
"[project]/src/app/admin/posts/[id]/edit/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EditPostPage({ params }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditPostPage.useEffect": ()=>{
            const loadPostAndCategories = {
                "EditPostPage.useEffect.loadPostAndCategories": async ()=>{
                    try {
                        setLoading(true);
                        setError(null);
                        // Load categories
                        const cats = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllCategories"])();
                        setCategories(cats.map({
                            "EditPostPage.useEffect.loadPostAndCategories": (cat)=>cat.name
                        }["EditPostPage.useEffect.loadPostAndCategories"]));
                        // Load post data
                        const posts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllPosts"])();
                        const post = posts.find({
                            "EditPostPage.useEffect.loadPostAndCategories.post": (p)=>p.slug === id || p.id?.toString() === id
                        }["EditPostPage.useEffect.loadPostAndCategories.post"]);
                        if (!post) {
    ...
    const handleFileUpload = async (e_0)=>{
        ...
        try {
            ...
            if (!response.ok) {
                const err_1 = await response.json();
                throw new Error(err_1.error || "Upload failed");
            }
            ...
            setError(err_0 instanceof Error ? err_0.message : "Failed to upload image");
            console.error("Upload error:", err_0);
        } finally{
            setUploading(false);
        }
    };
    ...
    const handleSave = async (status)=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updatePost"])(id, postData);
            router.push("/admin/posts");
        } catch (err_2) {
            setError(err_2 instanceof Error ? err_2.message : "Failed to update post");
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    formData.featuredImage && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(EditPostPage, "Pp0sEmlSLeGtsb6VtvBTlglW9rk=", false, function() {
    return [
...
//# sourceMappingURL=src_5ec8db0c._.js.map