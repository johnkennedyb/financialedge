...
function CategoriesPage() {
            ...
            const loadCategories = {
                "CategoriesPage.useEffect.loadCategories": async ()=>{
                    try {
                        setLoading(true);
                        setError(null);
                        const wpCategories = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllCategories"])();
                        const formattedCategories = wpCategories.map({
                            "CategoriesPage.useEffect.loadCategories.formattedCategories": (cat)=>({
                                    id: cat.id.toString(),
                                    name: cat.name,
                                    slug: cat.slug,
                        ...
                        }["CategoriesPage.useEffect.loadCategories.formattedCategories"]);
    ...
    const handleDelete = async (id)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteCategory"])(id);
            setCategories((prev)=>prev.filter((cat_0)=>cat_0.id !== id));
        } catch (err_0) {
...
_s(CategoriesPage, "PEFWK5NudK8G7IEShrERrFoV+TY=");
_c = CategoriesPage;
var _c;
...
//# sourceMappingURL=src_690075ed._.js.map