...
// Validate ../../src/app/admin/adverts/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/admin/adverts">> = Specific
  const handler = {} as typeof import("../../src/app/admin/adverts/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../src/app/api/admin/adverts/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/admin/adverts">> = Specific
  const handler = {} as typeof import("../../src/app/api/admin/adverts/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../src/app/api/admin/local/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/admin/local">> = Specific
  const handler = {} as typeof import("../../src/app/api/admin/local/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../src/app/api/admin/upload/cloudinary/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/admin/upload/cloudinary">> = Specific
  const handler = {} as typeof import("../../src/app/api/admin/upload/cloudinary/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
